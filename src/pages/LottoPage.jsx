...
const ANALYSES = [
  ...
  },
  {
    ...
    resultReview: [
      {
        title: '실제 결과 분석',
        text: '1241회 실제 당첨번호는 7, 13, 16, 23, 24, 43이고 보너스는 9였다. 기축일 추천군에서는 13과 24, 43이 살아났고, 특히 7·13·17·20·32·38 기시감 조합은 7·13 두 수를 맞히며 방향 일부가 맞았다.',
      },
      {
        title: '가장 가까웠던 조합',
        text: 'CODE E는 13·43 두 수, 기시감 조합은 7·13 두 수가 맞았다. CODE B·D는 24, CODE C·F는 13 한 수씩 적중했다. 실제 결과가 7·13·16·23·24·43처럼 10번대와 20번대 초반, 40번대 끝수를 함께 끌고 온 만큼 중앙 몰림만으로는 부족했다.',
      },
      {
        title: '다음 보정 포인트',
        text: '기축일 상위 빈도였던 14·20·18 중심축은 이번 회차에서 빗나갔다. 다음 분석에서는 일진 상위권을 고정축으로 과하게 쓰기보다, 직전 HOT인 13과 함께 16·23·24처럼 중간 연결수를 더 열어두는 방식이 필요하다.',
      },
    ],
    picks: [
      {
