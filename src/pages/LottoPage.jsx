...
const ANALYSES = [
  ...
  },
  {
    ...
    aiOpinion: [
      ...
      {
        title: 'AI 최종 의견',
        text: '원문 기준 정미일 추천은 26을 모든 조합의 고정축으로 둔 다중 패턴 포트폴리오다. 추가 14번은 경자일 31·43의 역할을 숫자 그대로 옮기지 않고, 정미일 안에서 기존 13게임이 소외한 방어수 2·15·30·35·44를 찾아 26 중심축과 결합한 보정형으로 둔다.',
      },
    ],
    resultReview: [],
    picks: [
      ...
      {
        name: '14 · 소외 방어수 종합형',
        numbers: [2, 15, 26, 30, 35, 44],
        note: '정미일 중심축 26에 기존 13게임에서 소외된 2·15·30·35·44를 붙인 보정형. 경자일 31·43의 역할을 정미일 데이터 안에서 다시 찾은 조합',
        featured: true,
      },
    ],
  },
...
const METHOD_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      '정미일에서는 기존 13게임이 26·20·4·33·34에 많이 묶였으므로, 정미일 20회 데이터에서 의미가 있는데 적게 쓰였거나 빠진 후보를 다시 본다.',
      '정미일 기준 소외 방어수는 2(4회, 기존 0회), 30(4회, 기존 1회), 15·35·44(각 3회, 기존 0회)처럼 데이터 안에 근거가 있으면서 포트폴리오에서 비어 있던 숫자다.',
      '정미일 14번 조합은 1~6번 기술을 모두 적용해 26을 중심축으로 두고, 소외 방어수 2·15·30·35·44를 함께 배치했다.',
    ],
  },
  {
    title: '5. 용지 분산 점수',
